/*! @file nearest_neighbor.h @brief Fournit une implémentation de l'algorithme du plus proche voisin : @ref nearest_neighbor() */
 ...
 * @note @ref nearest_neighbor() insert tous les sites du tableau @em sites dans le routing @em r.
 * @see routing_get_arrival_date(), routing_get_delivery_date()
 */
void nearest_neighbor(routing r, site * sites);
