...
\input{environnement_algorithmes_fr}
...
\input{parties/presentation-du-probleme}
\input{parties/cahier-des-charges}
%\input{parties/gestion-de-projet}
\input{parties/algorithme-heuristique}
\input{parties/implementation}
\input{parties/resultats}
