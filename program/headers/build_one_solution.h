 ...
 * @post Les tableaux de sites par groupe sont triés selon la tournée trouvée par @ref nearest_neighbor() au sein du groupe.
 ...
 * @note Les tournées sont trouvées grâce à la fonction @ref nearest_neighbor().
 */
